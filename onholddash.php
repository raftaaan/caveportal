                     ...
                     <div class="col-12">
                        <div class="card recent-sales overflow-auto">
                           ...
                           <ul class="nav nav-pills" id="pills-tab" role="tablist">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link active" href="onholddash.php" type="button" role="tab" aria-controls="pills-profile" aria-selected="true">On Hold Application (<?php echo $view->onHoldCount();?>)</a>
                              </li>
                              <li class="nav-item">
