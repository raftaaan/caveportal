...
<html lang="en">
   ...
   <body>
      <header id="header" class="header fixed-top d-flex align-items-center">
         <div class="d-flex align-items-center justify-content-between"><i class="bi bi-list toggle-sidebar-btn mx-3"></i> <a href="clientdash.php" class="logo d-flex align-items-center"> <img src="resource/img/CAVElogo.png" alt=""> <span class="d-none d-lg-block">Client</span> </a> </div>
      </header>
      <aside id="sidebar" class="sidebar">
         <ul class="sidebar-nav" id="sidebar-nav">
            <li class="nav-item"> <a class="nav-link collapsed" href="clientdash.php"> <i class="bi bi-grid"></i> <span>My Dashboard</span> </a></li>
            <li class="nav-heading">Options</li>
            <li class="nav-item"> <a class="nav-link " href="clientprofile.php"> <i class="bi bi-person"></i> <span>My Profile</span> </a></li>
      ...
      <main id="main" class="main">
         <div class="pagetitle" data-aos="fade-right" data-aos-duration="1000">
            <h1>Profile</h1>
            <nav>
               <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="clientdash.php">Home</a></li>
                  <li class="breadcrumb-item active"><a href="clientprofile.php">Profile</a></li>
               </ol>
            </nav>
         </div>
         <section class="section profile" id="section-profile" data-aos="fade-right" data-aos-duration="1000">
            <div class="row">
               <div class="col-xl-8">
                  <div class="card">
                        ...
                        <div class="tab-content pt-2">
                           ...
                           <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                              ...
                              <form method="POST">
                                 ...
                                 <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 col-lg-9"> <input name="fullName" type="text" class="form-control" id="fullName" value ="<?php echo escape($user->data()->name); ?>" placeholder="Full Name"></div>
                                 </div>
                                 <div class="row mb-3">
                           ...
                           <div class="tab-pane fade pt-3" id="profile-change-password">
                              ...
                              <?php
                                 ...
                                 <div class="text-center"> 
                                 <input type="hidden" name ="Token" value="<?php echo Token::generate();?>"/>
                                 <input type="submit" class="btn btn-primary" name="form2" value="Change Password"></div>
                              </form>
                           </div>
                        </div>
                     </div>
